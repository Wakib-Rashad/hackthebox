#### 8.1. Looking for SUID bins
```
www-data@redcross:/$ find / -perm -g=s -perm -u=s -type f 2>/dev/null
/opt/iptctl/iptctl
/usr/lib/xorg/Xorg.wrap
```


#### 8.2. Info about `iptctl`
```
www-data@redcross:/$ ls -la /opt/iptctl/iptctl
-rwsr-sr-x 1 U3 root 13152 Jun 10  2018 /opt/iptctl/iptctl
www-data@redcross:/$ /opt/iptctl/iptctl --help
Usage: /opt/iptctl/iptctl allow|restrict|show IP
www-data@redcross:/$ find / -name iptctl.c 2>/dev/null
...
#### 8.3. Source-code
```
trololol@redcross:~$ cat /var/jail/home/public/src/iptctl.c
/*
